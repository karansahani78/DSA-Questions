...
public class FruitsInBasketBruteForce {
    ...
    public static int totalFruit(int[] fruits) {
        ...
        then check if the hashset size more than 2 then it has more than 2 types of fruits in then break
         add fruits to the hashset and increase the counter
        then check if counter is greater than max fruits then now counter will be the max fruit
        then return the max fruits
         */
        int maxFruits = 0;
